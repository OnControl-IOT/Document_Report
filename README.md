...
|    2.5    |   30/11/25   |   Grupo   | Finalización de TF y correciones pasadas |
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <strong>TB2:</strong> <p align="justify"> Durante el proyecto trabajé de manera colaborativa con mi equipo, ejerciendo liderazgo conjunto en la planificación y realización de tareas. Contribuí en el desarrollo del backend, la documentación técnica, la base de datos y la actualización del frontend para su correcta integración.</p><br>
      <strong>TF:</strong> <p align="justify">Durante el proyecto, ejercí liderazgo técnico al modificar el frontend y desarrollar el servicio de borde (edge service) para integrarlo con el backend, creando un entorno de colaboración donde, junto con mi equipo, establecimos los objetivos, planificamos las tareas de implementación y cumplimos con el despliegue exitoso de todo el sistema.</p><br>
      ...
      <strong>TF1:</strong> <p align="justify">A través de un buen proceso durante sprint reviews anteriores, sprint backlog y reuniones continuas y diarias entre los miembros de grupo, hemos podido realizar un cierre correcto del proyecto, habiendo finalizado todos los detalles importantes.</p><br>
      ...
      <strong>TF:</strong> <p align="justify">Para la entrega final del curso me encargué de crear el prototipo del edge, que conecta al dispositivo con el backend, este es importante porque logra reducir la latencia, mejora la velocidad de respuesta y permite tomar decisiones de forma instantánea.</p><br>
      ...
      <td>
        ...
        Siguiendo las indicaciones identificadas durante el inicio del sprint y las reuniones grupales hemos realizado un cierre correcto del proyecto de forma aceptable al haber cumplido todos nuestros requerimientos puestos al inicio del desarrollo del backlog.
      </td>
    </tr>
    <tr>
      ...
      <strong>TB2:</strong> <p align="justify"> Fomenté un entorno colaborativo e inclusivo dentro del equipo, promoviendo la comunicación constante y el apoyo mutuo. Participé en la definición de metas del sprint, la planificación de tareas y la organización del trabajo, asegurando que cada miembro tuviera claridad en sus responsabilidades. Gracias a esta coordinación, se lograron cumplir los objetivos establecidos de manera eficiente. </p><br>
      <strong>TF:</strong> <p align="justify">Para garantizar la integración efectiva del frontend con el backend, creé un entorno de trabajo colaborativo e inclusivo, compartiendo conocimiento sobre el edge service que desarrollé. Esto nos permitió, como equipo, establecer metas claras para cada módulo, planificar las tareas de conexión y despliegue, y cumplir con el objetivo final de tener un sistema unificado y funcional.</p><br>
      <strong>Ramos Mendoza, Juan Pablo</strong><br>
      ...
      <strong>TF1:</strong> <p align="justify">Con el feedback durante el desarrollo de nuestro proyecto del profesor hemos seguido mejorando y realizando avances continuos, aplicando lo aprendido en sprints anteriores para realizar el cierre del proyecto.</p><br>
      <strong>Gray Hidalgo, Alejandro Eduardo</strong><br>
      ...
      <strong>TF:</strong> <p align="justify">Promoví un entorno colaborativo donde definí metas para poder realizar las tareas que se me encargaron como crear el sistema edge y poder realizarlas a tiempo para cumplir con las metas del grupo y del curso.</p>
      <strong>Quispe Roldan, Michael Fred</strong><br>
      ...
      <td>
        ...
        <strong>TF1:</strong><br>
        Durante el planteamiento del sprint y a través del feedback recibido durante cada etapa del proceso de desarrollo, hemos completado todos los requerimientos que nos hemos puesto al inicio del proyecto para llegar a este cierre aceptable.
      </td>
    </tr>
  </tbody>
</table>
